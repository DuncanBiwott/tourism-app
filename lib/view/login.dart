            ...
            child: Padding(
              ...
              child:  Column(
                    ...
                    children: [
                      ...
                      Center(child:  Text("Login",style: TextStyle(color: Colors.black,fontSize: 50),)),
                      ...
                      //  showCustomFlash(context,"Login Successfull");
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    style: ButtonStyle(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text("Login",style: TextStyle(color: Colors.white,letterSpacing: 0.5),),
                              ],
                            ),
                              )
